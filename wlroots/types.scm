...
(define-bs-struct %wlr-output-struct
  (impl (bs:pointer '*))
  ...
  (events (make-events
           ...
           commit present bind
           description request-state destroy))
...
(define-bs-struct %wlr-keyboard-struct
  ...
  (repeat-info (bs:struct `((rate ,int32)
                            (delay ,int32))))
  (events (make-events key modifiers keymap repeat-info))
  (data (bs:pointer 'void)))
...
(define-bs-struct %wlr-layer-surface-v1-struct
  (surface (bs:pointer %wlr-surface-struct))
  (output (bs:pointer %wlr-output-struct))
  (resource (bs:pointer %wl-resource-struct))
...
(define-bs-struct %wlr-gamma-control-manager-v1-struct
  (global (bs:pointer %wl-global-struct))
